...
it is required to update `02-vul-operator.rbac.yaml` rules to include new permissions
...
| Scan container images vulnerabilities                                                         | scan container for vulnerabilities<br/> and misconfiguration                                            | Pod,ReplicationController,ReplicaSet,<br/>StatefulSet,DaemonSet,Job,CronJob | Vul       | Vul                                                                                                                         |
