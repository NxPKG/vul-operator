...
An instance of the RbacAssessmentReport represents checks performed by configuration auditing tools, such as [Vul],
...
metadata:
  annotations:
    vul-operator.resource.name: system:controller:token-cleaner
  creationTimestamp: "2022-07-04T07:23:07Z"
  generation: 1
  labels:
    plugin-config-hash: 659b7b9c46
    resource-spec-hash: 59b6bf95c6
    vul-operator.resource.kind: Role
    vul-operator.resource.name-hash: 868458b9d6
