...
report:
  controlCheck:
    ...
    - checkResults:
        - details:
            - msg: Container 'vul-operator' of ReplicaSet 'vul-operator-7cf866c47b'
                should set 'securityContext.runAsNonRoot' to true
              name: replicaset-vul-operator-7cf866c47b
            ...
            - msg: Container 'coredns' of ReplicaSet 'coredns-5789895cd' should set 'securityContext.runAsNonRoot'
              ...
              namespace: kube-system
              status: FAIL
            - msg: Container 'vul-operator' of ReplicaSet 'vul-operator-c94dd56d'
                should set 'securityContext.runAsNonRoot' to true
              name: replicaset-vul-operator-c94dd56d
              namespace: vul-system
              status: FAIL
            - msg: Container 'local-path-provisioner' of ReplicaSet 'local-path-provisioner-84bb864455'
                should set 'securityContext.runAsNonRoot' to true
