...
An instance of the ConfigAuditReport represents checks performed by configuration auditing tools, such as [Vul],
...
metadata:
  ...
  labels:
    ...
    vul-operator.resource.name: nginx-6d4cf56db6
...
schema can be integrated with vul-operator.
