...
components and dependencies. For a multi-container workload vul-operator creates multiple instances
...
metadata:
  ...
  labels:
    ...
    vul-operator.container.name: kube-apiserver
    vul-operator.resource.kind: Pod
    vul-operator.resource.name: kube-apiserver-kind-control-plane
    vul-operator.resource.namespace: kube-system
...
report:
  ...
  components:
    ...
    - bom-ref: 9464f5f9-750d-4ea0-8705-c8d067b25b29
      name: debian
      properties:
      - name: khulnasoft:vul:Class
        value: os-pkgs
      - name: khulnasoft:vul:Type
        value: debian
      supplier: {}
    ...
    - bom-ref: pkg:deb/debian/tzdata@2021a-0+deb10u1?arch=all&distro=debian-10.9
      ...
      - name: khulnasoft:vul:SrcName
        value: tzdata
      - name: khulnasoft:vul:SrcRelease
        value: 0+deb10u1
      - name: khulnasoft:vul:SrcVersion
        value: 2021a
