...
import (
	...
	j "github.com/khulnasoft-lab/vul-kubernetes/pkg/jobs"
...
func (r *NodeReconciler) reconcileNodes() reconcile.Func {
	return func(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
		...
		nodeCollectorImageRef := r.GetVulOperatorConfig().NodeCollectorImageRef()
		coll := j.NewCollector(cluster,
			...
			j.WithJobLabels(map[string]string{
				...
				vuloperator.LabelResourceKind:      node.Kind,
				vuloperator.LabelResourceName:      node.Name,
			}))
