...
import (
	...
	"github.com/khulnasoft/vul-operator/pkg/apis/khulnasoft/v1alpha1"
	"github.com/khulnasoft/vul-operator/pkg/operator/etc"
	"github.com/khulnasoft/vul-operator/pkg/vuloperator"
...
var _ = Describe("ResourcesMetricsCollector", func() {
	...
	JustBeforeEach(func() {
		...
		var trvConfig = vuloperator.GetDefaultConfig()
	...
	Context("VulnerabilityReport", func() {
		BeforeEach(func() {
			...
			vr1.Labels = labels.Set{
				...
				vuloperator.LabelContainerName: "nginx",
				"tier":                           "tier-1",
				"owner":                          "team-a",
			...
			vr2.Labels = labels.Set{
				vuloperator.LabelResourceKind:  "ReplicaSet",
				vuloperator.LabelResourceName:  "app-d327abe3c4",
				vuloperator.LabelContainerName: "proxy"}
			...
			vr3.Labels = labels.Set{
				vuloperator.LabelResourceKind:  "DaemonSet",
				vuloperator.LabelResourceName:  "ingress-nginx-controller",
				vuloperator.LabelContainerName: "controller"}
		...
		It("should produce correct metrics with cluster scope", func() {
			const expected = `
		# HELP vul_image_vulnerabilities Number of container image vulnerabilities
		# TYPE vul_image_vulnerabilities gauge
		vul_image_vulnerabilities{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Critical"} 2
		vul_image_vulnerabilities{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="High"} 0
		vul_image_vulnerabilities{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Low"} 0
		vul_image_vulnerabilities{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Medium"} 0
		vul_image_vulnerabilities{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Unknown"} 0
		vul_image_vulnerabilities{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical"} 4
		vul_image_vulnerabilities{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High"} 7
		vul_image_vulnerabilities{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Low"} 0
		vul_image_vulnerabilities{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Medium"} 0
		vul_image_vulnerabilities{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Unknown"} 0
		vul_image_vulnerabilities{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Critical"} 1
		vul_image_vulnerabilities{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="High"} 0
		vul_image_vulnerabilities{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Low"} 0
		vul_image_vulnerabilities{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Medium"} 0
		vul_image_vulnerabilities{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Unknown"} 0
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_image_vulnerabilities")).
				To(Succeed())
		})
		...
		It("should produce correct metrics with cluster scope with MetricsVulnerabilityId option enabled", func() {
			...
			const expected = `
		# HELP vul_vulnerability_id Number of container image vulnerabilities group by vulnerability id
		# TYPE vul_vulnerability_id gauge
		vul_vulnerability_id{class="os-pkgs",container_name="nginx",fixed_version="2.28-11",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",installed_version="2.28-10",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",package_type="debian",pkg_path="ab",resource="libc-bin",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Critical",vuln_id="CVE-VR1-CRITICAL-1",vuln_score="8.5",vuln_title="VR1 Critical vulnerability 1"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="nginx",fixed_version="",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",installed_version="1.19.7",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",package_type="debian",pkg_path="ab",resource="dppkg",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Critical",vuln_id="CVE-VR1-CRITICAL-2",vuln_score="8.3",vuln_title="VR1 Critical vulnerability 2"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.2.11-r3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="zlib",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical",vuln_id="CVE-VR2-CRITICAL-1",vuln_score="7.5",vuln_title="VR2 Critical vulnerability 1"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.34.1-r3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="ssl_client",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical",vuln_id="CVE-VR2-CRITICAL-2",vuln_score="8.7",vuln_title="VR2 Critical vulnerability 2"} 1
		...
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.1.1l-r7",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="libssl1.1",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical",vuln_id="CVE-VR2-CRITICAL-4",vuln_score="9.5",vuln_title="VR2 Critical vulnerability 4"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v1.9.0",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/prometheus/client_golang",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-1",vuln_score="7",vuln_title="VR2 High vulnerability 1"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v0.0.0-20210711020723-a769d52b0f97",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/x/crypto",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-2",vuln_score="6.7",vuln_title="VR2 High vulnerability 2"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v0.0.0-20210226172049-e18ecbb05110",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/x/net",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-3",vuln_score="7.1",vuln_title="VR2 High vulnerability 3"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v0.3.3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/x/text",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-4",vuln_score="7",vuln_title="VR2 High vulnerability 4"} 1
		...
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.2.11-r3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="zlib",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical",vuln_id="CVE-VR2-CRITICAL-1",vuln_score="7.5",vuln_title="VR2 Critical vulnerability 1"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.34.1-r3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="ssl_client",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical",vuln_id="CVE-VR2-CRITICAL-2",vuln_score="8.7",vuln_title="VR2 Critical vulnerability 2"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.2.11-r3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="zlib",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical",vuln_id="CVE-VR2-CRITICAL-3",vuln_score="8.5",vuln_title="VR2 Critical vulnerability 3"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.1.1l-r7",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="libssl1.1",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical",vuln_id="CVE-VR2-CRITICAL-4",vuln_score="9.5",vuln_title="VR2 Critical vulnerability 4"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v1.9.0",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/prometheus/client_golang",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-1",vuln_score="7",vuln_title="VR2 High vulnerability 1"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v0.0.0-20210711020723-a769d52b0f97",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/x/crypto",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-2",vuln_score="6.7",vuln_title="VR2 High vulnerability 2"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v0.0.0-20210226172049-e18ecbb05110",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/x/net",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-3",vuln_score="7.1",vuln_title="VR2 High vulnerability 3"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="v0.3.3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="golang.org/x/text",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-4",vuln_score="7",vuln_title="VR2 High vulnerability 4"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.2.11-r3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="zlib",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-5",vuln_score="7",vuln_title="VR2 High vulnerability 5"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.34.1-r3",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="busybox",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-6",vuln_score="6",vuln_title="VR2 High vulnerability 6"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="proxy",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",installed_version="1.1.1l-r7",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",package_type="debian",pkg_path="ab",resource="libssl1.1",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High",vuln_id="CVE-VR2-HIGH-7",vuln_score="6.4",vuln_title="VR2 High vulnerability 7"} 1
		vul_vulnerability_id{class="os-pkgs",container_name="controller",custom_prefix_ssot="",custom_prefix_tier="",fixed_version="",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",installed_version="1.19.7",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",package_type="debian",pkg_path="ab",resource="dppkg",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Critical",vuln_id="CVE-VR3-CRITICAL-1",vuln_score="8.4",vuln_title="VR3 Critical vulnerability 1"} 1
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_vulnerability_id")).
				To(Succeed())
		})
		...
		It("should produce correct metrics with configured labels included using the correct prefix and sanitized the invalid metric label", func() {
			collector.Set(vuloperator.KeyReportResourceLabels, "app.kubernetes.io/name")
			collector.Set(vuloperator.KeyMetricsResourceLabelsPrefix, "custom_prefix_")
			collector.metricDescriptors = buildMetricDescriptors(collector.ConfigData) // Force rebuild metricDescriptors again
			const expected = `
		# HELP vul_image_vulnerabilities Number of container image vulnerabilities
	...
	Context("ExposedSecretReport", func() {
		...
		It("should produce correct metrics with cluster scope", func() {
			const expected = `
        # HELP vul_image_exposedsecrets Number of image exposed secrets
        # TYPE vul_image_exposedsecrets gauge
        vul_image_exposedsecrets{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Critical"} 2
        vul_image_exposedsecrets{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="High"} 0
        vul_image_exposedsecrets{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Low"} 0
        vul_image_exposedsecrets{container_name="nginx",image_digest="",image_registry="index.docker.io",image_repository="library/nginx",image_tag="1.16",name="replicaset-nginx-6d4cf56db6-nginx",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Medium"} 0
        vul_image_exposedsecrets{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Critical"} 4
        vul_image_exposedsecrets{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="High"} 3
        vul_image_exposedsecrets{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Low"} 0
        vul_image_exposedsecrets{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",severity="Medium"} 0
        vul_image_exposedsecrets{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Critical"} 0
        vul_image_exposedsecrets{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="High"} 0
        vul_image_exposedsecrets{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Low"} 0
        vul_image_exposedsecrets{container_name="controller",image_digest="sha256:5516d103a9c2ecc4f026efbd4b40662ce22dc1f824fb129ed121460aaa5c47f8",image_registry="k8s.gcr.io",image_repository="ingress-nginx/controller",image_tag="",name="daemonset-ingress-nginx-controller-controller",namespace="ingress-nginx",resource_kind="DaemonSet",resource_name="ingress-nginx-controller",severity="Medium"} 0
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_image_exposedsecrets")).
				To(Succeed())
		})
		...
		vul_exposedsecrets_info{container_name="proxy",image_digest="",image_registry="quay.io",image_repository="oauth2-proxy/oauth2-proxy",image_tag="v7.2.1",name="replicaset-app-d327abe3c4-proxy",namespace="some-ns",resource_kind="ReplicaSet",resource_name="app-d327abe3c4",secret_category="Stripe",secret_rule_id="stripe-secret-token",secret_target="/app/config/secret.yaml",secret_title="Stripe",severity="Critical"} 1
			`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_exposedsecrets_info")).
				To(Succeed())
		})
	...
	Context("ConfigAuditReport", func() {
		BeforeEach(func() {
			...
			car2.Labels = labels.Set{
				vuloperator.LabelResourceKind: "ConfigMap",
				vuloperator.LabelResourceName: "test"}
			...
			car3.Labels = labels.Set{
				vuloperator.LabelResourceKind: "ReplicaSet",
				vuloperator.LabelResourceName: "vault-agent-injector-65fd65bfb8"}
		...
		It("should produce correct metrics with cluster scope - Summary", func() {
			const expected = `
        # HELP vul_resource_configaudits Number of failing resource configuration auditing checks
        # TYPE vul_resource_configaudits gauge
        vul_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",severity="Critical"} 0
        vul_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",severity="High"} 0
        vul_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",severity="Low"} 1
        vul_resource_configaudits{name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",severity="Medium"} 0
        vul_resource_configaudits{name="replicaset-nginx-6d4cf56db6",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Critical"} 2
        vul_resource_configaudits{name="replicaset-nginx-6d4cf56db6",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="High"} 0
        vul_resource_configaudits{name="replicaset-nginx-6d4cf56db6",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Low"} 9
        vul_resource_configaudits{name="replicaset-nginx-6d4cf56db6",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Medium"} 0
        vul_resource_configaudits{name="replicaset-vault-agent-injector-65fd65bfb8",namespace="vault-system",resource_kind="ReplicaSet",resource_name="vault-agent-injector-65fd65bfb8",severity="Critical"} 0
        vul_resource_configaudits{name="replicaset-vault-agent-injector-65fd65bfb8",namespace="vault-system",resource_kind="ReplicaSet",resource_name="vault-agent-injector-65fd65bfb8",severity="High"} 0
        vul_resource_configaudits{name="replicaset-vault-agent-injector-65fd65bfb8",namespace="vault-system",resource_kind="ReplicaSet",resource_name="vault-agent-injector-65fd65bfb8",severity="Low"} 7
        vul_resource_configaudits{name="replicaset-vault-agent-injector-65fd65bfb8",namespace="vault-system",resource_kind="ReplicaSet",resource_name="vault-agent-injector-65fd65bfb8",severity="Medium"} 4
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_resource_configaudits")).
				To(Succeed())
		})
		...
		It("should produce correct metrics with cluster scope - Info", func() {
			...
			const expected = `
		# HELP vul_configaudits_info Number of failing resource configuration auditing checks Info
		# TYPE vul_configaudits_info gauge
		vul_configaudits_info{config_audit_category="car1 category for config audit",config_audit_description="car1 description for config audit",config_audit_id="car1 Id",config_audit_success="true",config_audit_title="car1 config audit title",name="replicaset-nginx-6d4cf56db6",namespace="default",resource_kind="ReplicaSet",resource_name="nginx-6d4cf56db6",severity="Critical"} 1
        vul_configaudits_info{config_audit_category="car2 category for config audit",config_audit_description="car2 description for config audit",config_audit_id="car2 Id",config_audit_success="true",config_audit_title="car2 config audit title",name="configmap-test",namespace="some-ns",resource_kind="ConfigMap",resource_name="test",severity="Critical"} 1
        vul_configaudits_info{config_audit_category="car3 category for config audit",config_audit_description="car3 description for config audit",config_audit_id="car3 Id",config_audit_success="true",config_audit_title="car3 config audit title",name="replicaset-vault-agent-injector-65fd65bfb8",namespace="vault-system",resource_kind="ReplicaSet",resource_name="vault-agent-injector-65fd65bfb8",severity="Critical"} 1
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_configaudits_info")).
				To(Succeed())
		})
	...
	Context("InfraAssessmentReport", func() {
		BeforeEach(func() {
			...
			car1.Labels = labels.Set{
				...
				vuloperator.LabelResourceName: "kube-apiserver-minikube-6d4cf56db6"}
			car1.Report.Checks = append(car1.Report.Checks,
				[]v1alpha1.Check{
					{
						ID:          "car1 Id",
		...
		It("should produce infra assessment metrics on kube-system namespace", func() {
			const expected = `
		# HELP vul_resource_infraassessments Number of failing k8s infra assessment checks
		# TYPE vul_resource_infraassessments gauge
		vul_resource_infraassessments{name="pod-kube-apiserver-minikube-6d4cf56db6",namespace="kube-system",resource_kind="Pod",resource_name="kube-apiserver-minikube-6d4cf56db6",severity="Critical"} 2
		vul_resource_infraassessments{name="pod-kube-apiserver-minikube-6d4cf56db6",namespace="kube-system",resource_kind="Pod",resource_name="kube-apiserver-minikube-6d4cf56db6",severity="High"} 0
		vul_resource_infraassessments{name="pod-kube-apiserver-minikube-6d4cf56db6",namespace="kube-system",resource_kind="Pod",resource_name="kube-apiserver-minikube-6d4cf56db6",severity="Low"} 9
		vul_resource_infraassessments{name="pod-kube-apiserver-minikube-6d4cf56db6",namespace="kube-system",resource_kind="Pod",resource_name="kube-apiserver-minikube-6d4cf56db6",severity="Medium"} 0
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_resource_infraassessments")).
				To(Succeed())
		})
		...
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_rbacassessments_info")).
				To(Succeed())
		})
	})
	...
	Context("RbacAssessment", func() {
		BeforeEach(func() {
			...
			car1.Labels = labels.Set{
				...
				vuloperator.LabelResourceName: "admin-6d4cf56db6"}
			car1.Report.Checks = append(car1.Report.Checks,
				[]v1alpha1.Check{
					{
						ID:          "car1 Id",
			...
			car2.Labels = labels.Set{
				vuloperator.LabelResourceKind: "Role",
				vuloperator.LabelResourceName: "write-test"}
			car2.Report.Checks = append(car2.Report.Checks,
				[]v1alpha1.Check{
					{
						ID:          "car2 Id",
			...
			car3.Labels = labels.Set{
				vuloperator.LabelResourceKind: "Role",
				vuloperator.LabelResourceName: "read-65fd65bfb8"}
			car3.Report.Checks = append(car3.Report.Checks,
				[]v1alpha1.Check{
					{
						ID:          "car3 Id",
		...
		It("should produce correct rbac assessment metrics with cluster scope", func() {
			const expected = `
		# HELP vul_role_rbacassessments Number of rbac risky role assessment checks
		# TYPE vul_role_rbacassessments gauge
		vul_role_rbacassessments{name="role-admin-6d4cf56db6",namespace="default",resource_kind="Role",resource_name="admin-6d4cf56db6",severity="Critical"} 2
		vul_role_rbacassessments{name="role-admin-6d4cf56db6",namespace="default",resource_kind="Role",resource_name="admin-6d4cf56db6",severity="High"} 0
		vul_role_rbacassessments{name="role-admin-6d4cf56db6",namespace="default",resource_kind="Role",resource_name="admin-6d4cf56db6",severity="Low"} 9
		vul_role_rbacassessments{name="role-admin-6d4cf56db6",namespace="default",resource_kind="Role",resource_name="admin-6d4cf56db6",severity="Medium"} 0
		vul_role_rbacassessments{name="role-read-65fd65bfb8",namespace="vault-system",resource_kind="Role",resource_name="read-65fd65bfb8",severity="Critical"} 0
		vul_role_rbacassessments{name="role-read-65fd65bfb8",namespace="vault-system",resource_kind="Role",resource_name="read-65fd65bfb8",severity="High"} 0
		vul_role_rbacassessments{name="role-read-65fd65bfb8",namespace="vault-system",resource_kind="Role",resource_name="read-65fd65bfb8",severity="Low"} 7
		vul_role_rbacassessments{name="role-read-65fd65bfb8",namespace="vault-system",resource_kind="Role",resource_name="read-65fd65bfb8",severity="Medium"} 4
		vul_role_rbacassessments{name="role-write-test",namespace="some-ns",resource_kind="Role",resource_name="write-test",severity="Critical"} 0
		vul_role_rbacassessments{name="role-write-test",namespace="some-ns",resource_kind="Role",resource_name="write-test",severity="High"} 0
		vul_role_rbacassessments{name="role-write-test",namespace="some-ns",resource_kind="Role",resource_name="write-test",severity="Low"} 1
		vul_role_rbacassessments{name="role-write-test",namespace="some-ns",resource_kind="Role",resource_name="write-test",severity="Medium"} 0
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_role_rbacassessments")).
				To(Succeed())
		})
	...
	Context("RbacAssessment", func() {
		...
		It("should produce correct cluster rbac assessment metrics", func() {
			const expected = `
		# HELP vul_clusterrole_clusterrbacassessments Number of rbac risky cluster role assessment checks
		# TYPE vul_clusterrole_clusterrbacassessments gauge
		vul_clusterrole_clusterrbacassessments{name="cluster_role-admin-6d4cf56db6",resource_kind="ClusterRole",resource_name="admin-6d4cf56db6",severity="Critical"} 2
		vul_clusterrole_clusterrbacassessments{name="cluster_role-admin-6d4cf56db6",resource_kind="ClusterRole",resource_name="admin-6d4cf56db6",severity="High"} 0
		vul_clusterrole_clusterrbacassessments{name="cluster_role-admin-6d4cf56db6",resource_kind="ClusterRole",resource_name="admin-6d4cf56db6",severity="Low"} 9
		vul_clusterrole_clusterrbacassessments{name="cluster_role-admin-6d4cf56db6",resource_kind="ClusterRole",resource_name="admin-6d4cf56db6",severity="Medium"} 0
		vul_clusterrole_clusterrbacassessments{name="cluster_role-read-65fd65bfb8",resource_kind="ClusterRole",resource_name="read-65fd65bfb8",severity="Critical"} 0
		vul_clusterrole_clusterrbacassessments{name="cluster_role-read-65fd65bfb8",resource_kind="ClusterRole",resource_name="read-65fd65bfb8",severity="High"} 0
		vul_clusterrole_clusterrbacassessments{name="cluster_role-read-65fd65bfb8",resource_kind="ClusterRole",resource_name="read-65fd65bfb8",severity="Low"} 7
		vul_clusterrole_clusterrbacassessments{name="cluster_role-read-65fd65bfb8",resource_kind="ClusterRole",resource_name="read-65fd65bfb8",severity="Medium"} 4
		vul_clusterrole_clusterrbacassessments{name="cluster_role-write-test",resource_kind="ClusterRole",resource_name="write-test",severity="Critical"} 0
		vul_clusterrole_clusterrbacassessments{name="cluster_role-write-test",resource_kind="ClusterRole",resource_name="write-test",severity="High"} 0
		vul_clusterrole_clusterrbacassessments{name="cluster_role-write-test",resource_kind="ClusterRole",resource_name="write-test",severity="Low"} 1
		vul_clusterrole_clusterrbacassessments{name="cluster_role-write-test",resource_kind="ClusterRole",resource_name="write-test",severity="Medium"} 0
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_clusterrole_clusterrbacassessments")).
				To(Succeed())
		})
	})
	...
	Context("clusterComplianceReport", func() {
		...
		It("should produce correct cluster rbac assessment metrics", func() {
			const expected = `
		# HELP vul_cluster_compliance cluster compliance report
		# TYPE vul_cluster_compliance gauge
		vul_cluster_compliance{description="National Security Agency - Kubernetes Hardening Guidance",status="Fail",title="nsa"} 12
		vul_cluster_compliance{description="National Security Agency - Kubernetes Hardening Guidance",status="Pass",title="nsa"} 15
		`
			Expect(testutil.CollectAndCompare(collector, strings.NewReader(expected), "vul_cluster_compliance")).
				To(Succeed())
		})
	})
})
