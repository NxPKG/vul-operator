...
* <https://github.com/khulnasoft/vul-operator>
...
| image.repository | string | `"khulnasoft/vul-operator"` |  |
...
| operator.builtInVulServer | bool | `false` | builtInVulServer The flag enable the usage of built-in vul server in cluster ,its also override the following vul params with built-in values vul.mode = ClientServer and serverURL = http://<serverServiceName>.<vul operator namespace>:4975 |
